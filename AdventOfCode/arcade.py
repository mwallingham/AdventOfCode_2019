...
class arcade_computer:
        ...
        while True:
            ...
            if str(self.program[self.fcursor]) != '99':
                ...
                if op == '05':
                    ...
                    self.program[ad3] = self.joystick
                    self.fcursor += 2
                    ...
                    if len(foutput) == self.output_length:
                        ...
                        if (x, y) == (-1, 0):
                            print("Score is {}".format(code))

                        else:
                            self.grid[y][x] = str(code)

                        self.print_to_screen()
                        foutput = []

                        if code == 'O':
                            self.joystick = self.move_to_ball()
    ...
    def move_to_ball(self):
        ...
        if self.ball_position > self.paddle_position:
            return 1
        elif self.ball_position < self.paddle_position:
            return -1
        else:
            return 0
